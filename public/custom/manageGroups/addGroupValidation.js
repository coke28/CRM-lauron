    ...
    // Private functions
     var initDatatable = function () {
       ...
       const fv = FormValidation.formValidation(
         document.getElementById('add_group_form'),
         {
           fields: {
             'groupName':{
               validators:{
       ...
       fv.on('core.form.valid', function() {
         ...
         document.getElementById('addGroupSubmitBtn').setAttribute('data-kt-indicator', 'on');
  
         // Disable button to avoid multiple click
         document.getElementById('addGroupSubmitBtn').disabled = true;
  
         // Simulate form submission. For more info check the plugin's official documentation: https://sweetalert2.github.io/
         var formx = $("#add_group_form")[0]; // You need to use standart javascript object here
         ...
         $.ajax({
           ...
           success: function (data){
             ...
             document.getElementById('addGroupSubmitBtn').setAttribute('data-kt-indicator', 'off');
             document.getElementById('addGroupSubmitBtn').disabled = false;
