      ...
      $.ajax({
        ...
        success: function (data){
          ...
          if(obj){
            ...
            $('#edit_group_form [name="groupName"]').val(obj.groupName);
            $('#edit_group_form [name="groupDescription"]').val(obj.groupDescription);
            $('#edit_group_form [name="client"]').val(obj.client);
