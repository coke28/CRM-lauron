...
var KTDatatablesServerSide = function () {
  ...
  var initDatatable = function () {
      dt = $("#verify_account_dt").DataTable({
                      ...
                      <a href="#" class="btn btn-primary btn-active-primary btn-sm" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end" data-kt-menu-flip="top-end">
                          ...
                          <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-150px py-4" data-kt-menu="true">
                              ...
                              <div class="menu-item px-3">
                                  <a href="/list/editAccount?campaignID=`+data.campaignID+`&mobileNumber=`+data.mobileNumber+'&campaignName='+data.campaignName+'&leadID='+data.leadID+'&fromVerified='+"verifyAdmin"+`" class="menu-link px-3">
                                      Update Account
                                  </a>
                              </div>
                              <!--end::Menu item-->
 ...
 var handleSearchDatatable = function () {
     const filterSearch = document.querySelector('#verifyAccountSearch');
...
KTUtil.onDOMContentLoaded(function () {
  ...
  jQuery(document).off('change', '#verifyAccountSearch');
  jQuery(document).on('change', '#verifyAccountSearch', function(e) {
    if($(this).val().length == 0){
      $("#verify_account_dt").DataTable().search($('#verifyAccountSearch').val()).draw();
    }
  });
