...
var KTDatatablesServerSide = function () {
                ...
                return `
                          ...
                          <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-150px py-4" data-kt-menu="true">
                              ...
                              <div class="menu-item px-3">
                                  <a href="#" class="menu-link px-3" data-kt-docs-table-filter="edit_row" id="edit_status_btn" data-id="`+data.id+`" data-bs-toggle="modal" data-bs-target="#editStatus">
                                      Edit
                                  </a>
                              </div>
                              <!--end::Menu item-->
                              ...
                              <!--begin::Menu item-->
                              <div class="menu-item px-3">
                                  <a href="#" id="delete_status" data-id="`+data.id+`" data-statusName="`+data.statusName+`" class="menu-link px-3" data-kt-docs-table-filter="delete_row">
                                      Delete
                                  </a>
                              </div>
                              <!--end::Menu item-->
 ...
 var handleSearchDatatable = function () {
     const filterSearch = document.querySelector('#statusSearch');
...
KTUtil.onDOMContentLoaded(function () {
  ...
  jQuery(document).off('change', '#statusSearch');
  jQuery(document).on('change', '#statusSearch', function(e) {
    if($(this).val().length == 0){
      $("#status_dt").DataTable().search($('#statusSearch').val()).draw();
    }
  });
