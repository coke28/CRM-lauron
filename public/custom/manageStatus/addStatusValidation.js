// Class definition
var addStatusValidation = (function () {
  // Private functions
  var initDatatable = function () {
      const fv = FormValidation.formValidation(
          document.getElementById("add_status_form"),
          {
              fields: {
                  client: {
                      validators: {
      ...
      fv.on("core.form.valid", function () {
          ...
          document
              .getElementById("addStatusSubmitBtn")
              .setAttribute("data-kt-indicator", "on");

          // Disable button to avoid multiple click
          document.getElementById("addStatusSubmitBtn").disabled = true;

          // Simulate form submission. For more info check the plugin's official documentation: https://sweetalert2.github.io/
          var formx = $("#add_status_form")[0]; // You need to use standart javascript object here
          var formDatax = new FormData(formx);
          //use displayTab
          formDatax.append("displayTableArray", $('#addDisplayTable').val());
