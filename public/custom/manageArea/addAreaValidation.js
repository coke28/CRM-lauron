    ...
    // Private functions
     var initDatatable = function () {
       ...
       const fv = FormValidation.formValidation(
         document.getElementById('area_form'),
         {
           fields: {
             'area':{
                validators:{
       ...
       fv.on('core.form.valid', function() {
         ...
         document.getElementById('addAreaSubmitBtn').setAttribute('data-kt-indicator', 'on');
  
         // Disable button to avoid multiple click
         document.getElementById('addAreaSubmitBtn').disabled = true;
  
         // Simulate form submission. For more info check the plugin's official documentation: https://sweetalert2.github.io/
         var formx = $("#area_form")[0]; // You need to use standart javascript object here
         ...
         $.ajax({
           ...
           success: function (data){
             ...
             document.getElementById('addAreaSubmitBtn').setAttribute('data-kt-indicator', 'off');
             document.getElementById('addAreaSubmitBtn').disabled = false;
