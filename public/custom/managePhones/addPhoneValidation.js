// Class definition
var addPhoneValidation = (function () {
    // Private functions
    var initDatatable = function () {
        const fv = FormValidation.formValidation(
            document.getElementById("add_phone_form"),
            {
                fields: {
                    'phoneBrand': {
                        validators: {
        ...
        fv.on("core.form.valid", function () {
            ...
            document
                .getElementById("addPhoneSubmitBtn")
                .setAttribute("data-kt-indicator", "on");

            // Disable button to avoid multiple click
            document.getElementById("addPhoneSubmitBtn").disabled = true;

            // Simulate form submission. For more info check the plugin's official documentation: https://sweetalert2.github.io/
            var formx = $("#add_phone_form")[0]; // You need to use standart javascript object here
