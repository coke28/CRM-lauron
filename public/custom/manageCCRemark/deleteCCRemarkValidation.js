$(document).ready(function (){
    ...
    jQuery(document).off('click', '#delete_cc_remark_type');
    jQuery(document).on('click', '#delete_cc_remark_type', function(e) {
      e.preventDefault();
      var id = $(this).data('id');
      ...
      Swal.fire({
          ...
          if(result.isConfirmed){
            var target = document.querySelector("#cc_remark_dt");
