  ...
  var KTDatatablesServerSide = function () {
    ...
    var initDatatable = function () {
        dt = $("#account_dt").DataTable({
            ...
            ajax: {
                url: "/list/accountListGlobeDataTable",
                type: "post",
                    ...
                    `;
                        ...
                        return `
                            <a href="#" class="btn btn-primary btn-active-primary btn-sm" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end" data-kt-menu-flip="top-end">
                                `+data.verifier+`/10 Times Called Previously
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-150px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <a href="/list/editAccount?campaignID=`+data.campaignID+`&mobileContactNumber=`+data.mobileContactNumber+`" class="menu-link px-3">
                                        Update Account
                                    </a>
                                </div>
                                <!--end::Menu item-->
   ...
   var handleSearchDatatable = function () {
       const filterSearch = document.querySelector('#accountSearch');
  ...
  KTUtil.onDOMContentLoaded(function () {
    ...
    jQuery(document).off('change', '#accountSearch');
    jQuery(document).on('change', '#accountSearch', function(e) {
      if($(this).val().length == 0){
        $("#account_dt").DataTable().search($('#accountSearch').val()).draw();
      }
    });
