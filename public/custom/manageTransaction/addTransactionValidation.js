// Class definition
var addTransactionValidation = function () {
    // Private functions
     var initDatatable = function () {
       ...
       fv.on('core.form.valid', function() {
         ...
         document.getElementById('addTransactionSubmitBtn').setAttribute('data-kt-indicator', 'on');
  
         // Disable button to avoid multiple click
         document.getElementById('addTransactionSubmitBtn').disabled = true;
  
         // Simulate form submission. For more info check the plugin's official documentation: https://sweetalert2.github.io/
         var formx = $("#transaction_form")[0]; // You need to use standart javascript object here
         ...
         $.ajax({
           ...
           success: function (data){
             ...
             document.getElementById('addTransactionSubmitBtn').setAttribute('data-kt-indicator', 'off');
             document.getElementById('addTransactionSubmitBtn').disabled = false;
