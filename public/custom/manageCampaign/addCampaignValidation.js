// Class definition
var addCampaignValidation = function () {
    // Private functions
     var initDatatable = function () {
       ...
       fv.on('core.form.valid', function() {
         ...
         document.getElementById('addCampaignSubmitBtn').setAttribute('data-kt-indicator', 'on');
  
         // Disable button to avoid multiple click
         document.getElementById('addCampaignSubmitBtn').disabled = true;
  
         // Simulate form submission. For more info check the plugin's official documentation: https://sweetalert2.github.io/
         var formx = $("#add_campaign_form")[0]; // You need to use standart javascript object here
         ...
         $.ajax({
           ...
           success: function (data){
             ...
             if(data.success){
              ...
              $("#add_campaign_form").trigger("reset");
             ...
             document.getElementById('addCampaignSubmitBtn').setAttribute('data-kt-indicator', 'off');
             document.getElementById('addCampaignSubmitBtn').disabled = false;
