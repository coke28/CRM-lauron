  ...
  var KTDatatablesServerSide = function () {
    ...
    var initDatatable = function () {
        dt = $("#crm_client_dt").DataTable({
            ...
            search: {
                input: $('#crmClientSearch'),
                key: 'dtsearch'
            },
            ajax: {
                url: "/crmClientDataTable",
                type: "post",
                  ...
                  return `
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-150px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <a href="#" class="menu-link px-3" data-kt-docs-table-filter="edit_row" id="edit_crm_client_btn" data-id="`+data.id+`" data-bs-toggle="modal" data-bs-target="#editCrmClient">
                                        Edit
                                    </a>
                                </div>
                                <!--end::Menu item-->
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="#" id="delete_crm_client" data-id="`+data.id+`" data-clientName="`+data.clientName+`" class="menu-link px-3" data-kt-docs-table-filter="delete_row">
                                        Delete
                                    </a>
                                </div>
                                <!--end::Menu item-->
   ...
   var handleSearchDatatable = function () {
       const filterSearch = document.querySelector('#crmClientSearch');
  ...
  KTUtil.onDOMContentLoaded(function () {
    ...
    jQuery(document).off('change', '#crmClientSearch');
    jQuery(document).on('change', '#crmClientSearch', function(e) {
      if($(this).val().length == 0){
        $("#crm_client_dt").DataTable().search($('#crmClientSearch').val()).draw();
      }
    });
