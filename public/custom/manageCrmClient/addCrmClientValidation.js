// Class definition
var addCrmClientValidation = function () {
    // Private functions
     var initDatatable = function () {
   
  
       const fv = FormValidation.formValidation(
         document.getElementById('add_crm_client_form'),
         {
           fields: {
             'clientName':{
               validators:{
       ...
       fv.on('core.form.valid', function() {
         ...
         document.getElementById('addCrmClientSubmitBtn').setAttribute('data-kt-indicator', 'on');
  
         // Disable button to avoid multiple click
         document.getElementById('addCrmClientSubmitBtn').disabled = true;
  
         // Simulate form submission. For more info check the plugin's official documentation: https://sweetalert2.github.io/
         var formx = $("#add_crm_client_form")[0]; // You need to use standart javascript object here
         ...
         $.ajax({
           ...
           success: function (data){
             ...
             if(data.success){
              ...
              $("#add_crm_client_form").trigger("reset");
             ...
             document.getElementById('addCrmClientSubmitBtn').setAttribute('data-kt-indicator', 'off');
             document.getElementById('addCrmClientSubmitBtn').disabled = false;
