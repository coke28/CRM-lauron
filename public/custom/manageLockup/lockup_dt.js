  ...
  var KTDatatablesServerSide = function () {
                  ...
                  return `
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-150px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <a href="#" class="menu-link px-3" data-kt-docs-table-filter="edit_row" id="edit_lockup_btn" data-id="`+data.id+`" data-bs-toggle="modal" data-bs-target="#editLockup">
                                        Edit
                                    </a>
                                </div>
                                <!--end::Menu item-->
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="#" id="delete_lockup" data-id="`+data.id+`" data-statusName="`+data.statusName+`" class="menu-link px-3" data-kt-docs-table-filter="delete_row">
                                        Delete
                                    </a>
                                </div>
                                <!--end::Menu item-->
   ...
   var handleSearchDatatable = function () {
       const filterSearch = document.querySelector('#lockupSearch');
  ...
  KTUtil.onDOMContentLoaded(function () {
    ...
    jQuery(document).off('change', '#lockupSearch');
    jQuery(document).on('change', '#lockupSearch', function(e) {
      if($(this).val().length == 0){
        $("#lockup_dt").DataTable().search($('#lockupSearch').val()).draw();
      }
    });
