...
<script src="{{ '/js/app.js?v='.rvndev()->getRandom(10) }}"></script>
<script src="{{ '/custom/callbackNotif/callbackNotif.js?v='.rvndev()->getRandom(10) }}"></script>
