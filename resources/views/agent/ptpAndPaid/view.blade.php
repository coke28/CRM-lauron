<x-base-layout>
    <div class="card card-custom">
      <div class="card-body">
          ...
          <div class="d-flex justify-content-end">
            ...
            <div class="d-flex align-items-center position-relative my-1 mb-2 mb-md-0 ">
              <div class="input-group input-group-solid">
                ...
                <input type="text" id="ptpAndPaidSearch" class="form-control form-control-lg form-control-solid"
                  placeholder="Search">
        ...
        <!--end::Wrapper-->
        <!--begin::Datatable-->
        <table id="ptp_paid_accounts_dt" class="table table-rounded table-striped border gy-7 gs-7">
          <thead>
    ...
    @section('scripts')
    <script type="text/javascript" src="{{ "/".'custom/agent/ptpAndPaid/ptpAndPaid_dt.js?v='. rvndev()->getRandom(30) }}"></script>
    @endsection
