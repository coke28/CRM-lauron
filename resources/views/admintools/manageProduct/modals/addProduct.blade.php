<div class="modal fade" id="addProducts" data-bs-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="addProducts" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <form class="form" id="add_products_form">
                <div class="row mb-6">
              ...
              <div class="modal-footer">
                  ...
                  <button type="submit" id="addProductsSubmitBtn" class="btn btn-primary font-weight-bold">Add Product</button>
              </div>
            </form>
        </div>
    </div>
