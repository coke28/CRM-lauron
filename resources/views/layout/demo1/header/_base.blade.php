...
<div id="kt_header" style="" class="header {{ theme()->printHtmlClasses('header', false) }} align-items-stretch" {{ theme()->printHtmlAttributes('header') }}>
	...
	<div class="{{ theme()->printHtmlClasses('header-container', false) }} d-flex align-items-stretch justify-content-between">
		<div class="lauronLogo">
			<img class="imageLogo" src="{{ asset('demo1/media/logos/lauronLogo.png') }}">
		</div>
		...
		@else
			...
			<div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
				<a href="{{ theme()->getPageUrl('index') }}" class="d-lg-none">
					<img alt="Logo" src="{{ asset('demo1/media/logos/lauronLogo.png') }}" class="h-35px logo">
				</a>
			</div>
			<!--end::Mobile logo-->
		@endif --}}
		...
		<!--begin::Wrapper-->
		<div id="mainHeader" class="d-flex align-items-stretch justify-content-between flex-lg-grow-1">
			<!--begin::Navbar-->
