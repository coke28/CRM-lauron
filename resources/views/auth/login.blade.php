<x-auth-layout>
    ...
    <!--begin::Signin Form-->
    <form method="POST" action="{{ theme()->getPageUrl('login') }}" class="form w-100" novalidate="novalidate" id="loginForm">
    @csrf
        ...
        <div class="text-center mb-10">
            ...
            <h1 class="text-dark mb-3">
                {{ __('Sign In') }}<br><br> <img src="{{ asset('demo1/media/logos/lauronLogo.png') }}" class="h-150px logo">
                {{-- <br> <img src="{{ asset('demo1/media/logos/diallinkLogo.png') }}" class="h-20px  logo"> --}}
            </h1>
            <!--end::Title-->
        ...
        {{-- <div class="fv-row mb-10">
            ...
            <!--begin::Input-->
            <input class="form-control form-control-lg form-control-solid" type="email" name="email" autocomplete="off" value="{{ old('email', '1demo@demo.com') }}" required autofocus/>
            <!--end::Input-->
        </div> --}}
        <!--end::Input group-->
        ...
        <div class="text-center">
            <!--begin::Submit button-->
            <button type="submit" id="loginSubmitButton" class="btn btn-lg btn-primary w-100 mb-5">
    ...
    @section('scripts')
        <script type="text/javascript" src="{{ "/".'custom/auth/login.js?v='. rvndev()->getRandom(30) }}"></script>
      @endsection
